...
Creates the working directories, seeds .env, and optionally installs
...
def setup_environment():
    ...
    if env_example.exists() and not env_file.exists():
        ...
        print("Edit .env and add your GROQ_API_KEY (or GOOGLE_API_KEY with LLM_PROVIDER=gemini)")
...
def setup_frontend():
    ...
    if frontend_dir.exists():
        ...
        try:
            ...
            print("ERROR: npm not found. Please install Node.js to set up the frontend")
    else:
